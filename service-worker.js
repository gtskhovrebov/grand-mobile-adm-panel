const CACHE='grand-mobile-administration-panel-v2-0-final';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-152.png','./icon-167.png','./icon-180.png','./icon-192.png','./icon-512.png'];
